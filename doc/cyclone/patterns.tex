...
\hyperlink{let-decls}{let declarations} because they have fewer
complications.  Then we describe all the \hyperlink{pat-forms}{pattern
  forms}.  Then we describe \hyperlink{switch-stmt}{switch
  statements}.
...
\subsection{Let Declarations}\hypertarget{let-decls}{}
...
\subsection{Pattern Forms}\hypertarget{pat-forms}{}
...
\subsection{Switch Statements}\hypertarget{switch-stmt}{}
...
\hyperlink{wild-pat}{wildcard pattern}.  For performance reasons,
