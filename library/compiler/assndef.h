...
namespace AssnDef
{
  ...
  extern term_t apply_aggr_update ( term_t a
                                  , List::list_t<$(int, type_opt_t) @> fields
                                  , term_t v);
  ...
  extern assn_t merge_assnmaps ( List::list_t<vardecl_opt_t> vds1, assn_map_t a1
                               , List::list_t<vardecl_opt_t> vds2, assn_map_t a2);
  ...
  extern assn_t subst_args ( List::list_t<vardecl_opt_t> args
                           , vardecl_opt_t res
                           , List::list_t<term_t> actual_args
                           , term_opt_t actual_res
                           , term_t mem
                           , assn_map_t am);
