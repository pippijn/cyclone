...
namespace Absyn
{
  ...
  typedef datatype EffConstraint @effconstr_t,
                                 *effconstr_opt_t;
#if 0
  ...
  EXTERN_ABSYN datatype Raw_exp
  {
    ...
    Aggregate_e (typedef_name_t, types_t, //witness types, maybe fewer before type-checking
                 ...
                 struct Aggrdecl *);
    // { .x1 = e1, ...., .xn = en }
    AnonStruct_e (type_opt_t, bool tuple,
                  list_t<$(list_t<designator_t>, exp_t) @>);
    // Foo (e1, ..., en)
  ...
  EXTERN_ABSYN datatype Raw_stmt
  {
    ...
    // switch statement
    Switch_s (exp_t,
              list_t<switch_clause_t>,
              Tcpat::decision_opt_t);
  ...
  EXTERN_ABSYN datatype Raw_decl
  {
    ...
    ExternCinclude_d (list_t<decl_t>,
                      list_t<decl_t>,
                      list_t<$(seg_t, qvar_t, bool) @>,
                      $(seg_t, list_t<qvar_t>) @);
    Porton_d;
    Portoff_d;
    Tempeston_d;
  ...
  EXTERN_ABSYN @extensible datatype AbsynAnnot
  {
    EXTERN_ABSYN EmptyAnnot;
  };
  ...
  int varlist_cmp (list_t<var_t> a,
                   list_t<var_t> b);
  ...
  // regions
  extern rgntype_t heap_rgn_type,
                   unique_rgn_shorthand_type,
                   refcnt_rgn_shorthand_type;
  // alias qualifiers types
  extern aqualtype_t al_qual_type,
                     un_qual_type,
                     rc_qual_type,
                     rtd_qual_type;
  // empty effect
  ...
  extern type_t void_type,
         ...
         typedef_type (typedef_name_t,
                       types_t, struct Typedefdecl *`H,
                       type_opt_t);
